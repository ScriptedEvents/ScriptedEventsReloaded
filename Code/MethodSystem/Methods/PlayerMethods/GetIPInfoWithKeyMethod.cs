...
[UsedImplicitly]
public class GetIPInfoWithKeyMethod : YieldingReferenceReturningMethod<IPInfo>, ICanError, IAdditionalDescription
{
    public override string Description => 
        "Fetches information about a provided player IP address using an API key (ProxyCheck.io v3).";

    public string AdditionalDescription => 
        "Requires an API key from https://proxycheck.io/. " +
        "This method provides detailed information including risk and confidence scores using the v3 API. " +
        "The free tier typically allows up to 1,000 requests per day.";
    ...
    public override IEnumerator<float> Execute()
    {
        ...
        // v3 always returns risk, asn, etc in nested structure
        string url = $"https://proxycheck.io/v3/{ip}?key={key}";
